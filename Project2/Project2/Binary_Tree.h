...
public:
	...
	*/
	...
	/*
	void set_left_tree(Binary_Tree<Item_Type>* new_left_tree) {
		BTNode<Item_Type>* left_root = new_left_tree->root;
		BTNode<Item_Type>* this_root = root;
		root->left = new_left_tree->root;
	}
	*/
